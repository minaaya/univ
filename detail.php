  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.php" class="logo"><b>Students Free</b></a>
            <!--logo end-->
      ...
      <section id="main-content">
    	...
    	<!--div class="col-md-4 col-sm-4 mb">
                      		...
                      		<div class="white-panel pn donut-chart">
								...
								<div class="row">
									<div class="col-sm-6 col-xs-6 goleft">
										<p><i class=""></i> Test De TP Analyse </p>
									</div>
	                      		</div>
								<canvas id="serverstatus01" height="120" width="120"></canvas>
								<!--<script>
    	...
    	<div class="col-md-4 col-sm-4 mb">
                      		...
                      		<div class="white-panel pn donut-chart">
								...
								<div class="row">
									<div class="col-sm-6 col-xs-6 goleft">
										<p><i class=""></i> Test De Cours Analyse</p>
									</div>
	                      		</div>
								<canvas id="serverstatus01" height="120" width="120"></canvas>
								<!--<script>
    ...
    <script src="assets/js/sparkline-chart.js"></script>
	  ...
	  <script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            title: 'Welcome to Students Free!',
            // (string | mandatory) the text inside the notification
            text: 'Hello and welcome to our website for students in University BBA',
